...
**技术栈：** Flutter、Material 3、ChangeNotifier、flutter_test、现有 CampaignController/CampaignCharacterController。
...
- `apps/client_flutter/test/campaign_chat_character_test.dart`：页面级权限、导航、角色卡和发送回归。
...
```powershell
flutter test test/campaign_avatar_test.dart test/campaign_chat_character_test.dart
```
...
```powershell
git add apps/client_flutter/lib/src/features/campaigns/presentation/widgets/campaign_avatar.dart apps/client_flutter/lib/src/features/campaigns/presentation/campaign_chat_page.dart apps/client_flutter/lib/src/features/campaigns/presentation/chat/campaign_chat_bubble.dart apps/client_flutter/lib/src/features/campaigns/presentation/chat/campaign_chat_tool_sheet.dart apps/client_flutter/lib/src/features/campaigns/presentation/chat/chat_avatar.dart apps/client_flutter/test/campaign_avatar_test.dart apps/client_flutter/test/campaign_chat_character_test.dart
...
test('groups adjacent ordinary messages from the same speaker', () {
  final first = message(id: '1', characterId: 'character-1', at: '2026-07-22T10:00:00Z');
  final second = message(id: '2', characterId: 'character-1', at: '2026-07-22T10:03:00Z');
...
```powershell
flutter test test/campaign_chat_character_test.dart --plain-name "chat app bar only exposes campaign navigation"
```
...
运行：`flutter test test/campaign_chat_character_test.dart`
...
```powershell
git add apps/client_flutter/lib/src/features/campaigns/presentation/campaign_chat_page.dart apps/client_flutter/test/campaign_chat_character_test.dart
...
运行：`flutter test test/campaign_chat_character_test.dart --plain-name "tool sheet keeps the current UI but groups actions by frequency"`
...
```powershell
git add apps/client_flutter/lib/src/features/campaigns/presentation/chat/campaign_chat_tool_sheet.dart apps/client_flutter/test/campaign_chat_character_test.dart
...
```powershell
flutter test test/campaign_avatar_test.dart test/campaign_chat_composer_test.dart test/campaign_chat_timeline_test.dart test/campaign_chat_character_test.dart
```
...
```powershell
git add apps/client_flutter/test/campaign_chat_composer_test.dart apps/client_flutter/test/campaign_chat_timeline_test.dart apps/client_flutter/test/campaign_chat_character_test.dart docs/roadmap/current-execution-status.md
